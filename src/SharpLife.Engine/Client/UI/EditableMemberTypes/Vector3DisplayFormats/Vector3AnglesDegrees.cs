...
{
    public sealed class Vector3AnglesDegrees : IVector3Display
    {
        ...
        public Vector3AnglesDegrees(int index, object editObject, MemberInfo info, Type type, ObjectAccessor objectAccessor)
        {
